...
#declare Cone_Mirror = cone {
    <0, 3, 0>, 1.5,    // 底面中心在原点，半径 1.2
    <0, 0, 0>, 0.0     // 顶端高度为 3，半径为 0（尖顶）
    texture { T_Chrome_5E }
    finish { 
        Metallic_Finish 
        reflection { 0.9 } 
...
#declare rond=object {Cone_Mirror}
...
#if(rendering=1) 
    object{image scale<6.89446896, 1, 11.5920324> rotate (-90)*y }//modify this line 
#end 
