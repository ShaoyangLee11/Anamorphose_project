...
#declare Cylinder_Mirror = cylinder {
    <0, 0, 0>, <0, 2.5, 0>, 0.5  // 半径设为0.8，可根据需要调整
    texture { T_Chrome_5E }
    finish { 
        Metallic_Finish 
        reflection { 0.9 } // 提高反射率以获得更好的变形效果
    }
}
// Image mapping
...
#declare rond=object {Cylinder_Mirror}
...
#if(rendering=1) 
    object{image scale<36.4506444, 1, 35.939194799999996> rotate (-90)*y }//modify this line 
#end 
