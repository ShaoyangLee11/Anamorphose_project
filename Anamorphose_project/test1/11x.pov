...
global_settings { 
    max_trace_level 255
    photons {
        spacing 0.01 // 数值越小，光子越密集，反射光影越细腻
        autostop 0
    }
...
// Egg shape definition
#declare Egg_upperpart = intersection{ sphere{<0,0,0>,1 scale<1,1.75,1>} box{<-1,0,-1>,<1,1.75,1>} } 
#declare Egg_lowerpart = intersection{ sphere{<0,0,0>,1 scale<1,1,1>} box{<-1,-1,-1>,<1,0,1>} } 
#declare Egg = union{ 
...
#if(rendering=1) 
    object{image scale<81.43837485, 1, 32.575349949999996> rotate (-90)*y }//modify this line 
#end 
