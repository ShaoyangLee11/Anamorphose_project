...
public class Anamorph5 extends ImagePlus implements PlugIn{
	...
	private double mstepx=0.5,mstepy=0.5 ;
	...
	public void run(String arg) {
		...
		ImagePlus imp=IJ.openImage("D:/test1/xjtupolimi.png"); 
		...
		try{
			...
			File source=new File("D:/test1/quadri.txt"); 
		...
		*/
		...
		inverted.show();
		System.out.println("\n\n Copy the following line at line 219 in anamorphoseTemplate.pov");
		System.out.println("scale<"+ma*scaleb*2+",1,"+mb*scaleb*2+">"); 
